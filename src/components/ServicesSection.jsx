...
import { Factory, Home, Trees, Ruler, FileCheck, Truck } from "lucide-react";
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white border border-gray-100 rounded-2xl p-7 shadow-md hover:shadow-yellow-100 hover:border-yellow-300 transition-all duration-300 cursor-default group"
              >
                {service.badge && (
                ...
                <div className="bg-yellow-100 p-3 rounded-xl inline-flex mb-5 group-hover:bg-yellow-500 transition-colors duration-300">
                  <Icon size={28} className="text-yellow-600 group-hover:text-white transition-colors duration-300" />
                </div>
