      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -top-4 -left-4 w-full h-full border-4 border-[#ff9422] rounded-2xl z-0" />
            <img
              src={awardImage}
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              <div className="bg-[#ffe4bf] p-3 rounded-full">
                <Award size={28} className="text-[#cc6100]" />
              </div>
            ...
            <div className="inline-flex items-center gap-2 mb-5">
              <Star size={14} className="text-[#FF7900] fill-[#FF7900]" />
              <span className="text-[#994800] font-semibold text-sm">Entrepreneur of the Year — Real Estate</span>
            </div>
            ...
            <div className="flex gap-1 mb-6">
              {[...Array(5)].map((_, i) => (
                ...
                >
                  <Star size={22} className="text-[#ff9422] fill-[#ff9422]" />
                </motion.div>
              ))}
            </div>

            <blockquote className="border-l-4 border-[#FF7900] pl-4 text-gray-500 italic text-sm mb-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-[#994800] font-medium border border-[#ff9422] rounded-lg px-4 py-2 hover:bg-[#fff4e6] transition"
            >
              <Award size={15} />
